          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              {item.cta && (
                <Button
                  size="lg"
                  className="bg-mi-primary cursor-pointer hover:bg-mi-primary/90 text-white font-body px-8 py-3"
                  asChild>
              ...
              <WhatsAppButton
                variant="outline"
                size="lg"
                className="border-mi-primary cursor-pointer text-white hover:bg-mi-primary hover:text-white px-8 py-3"
