      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="font-body text-lg text-mi-secondary max-w-3xl mx-auto">
            We're committed to bringing you products that combine innovation, quality, and style. Our curated collection
            represents the best in modern design and functionality.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <p className="font-body text-sm text-mi-secondary">{feature.description}</p>
            </div>
          ))}
        </div>
      </div>
